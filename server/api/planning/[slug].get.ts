...
export default defineEventHandler(async (event) => {
  ...
  const [activities, proposal, availability, viewerAvailability] = await Promise.all([db.query(`select coalesce(a.name,pa.custom_label) as name from profile_activities pa
