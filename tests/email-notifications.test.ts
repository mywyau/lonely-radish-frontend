...
describe('email notifications', () => {
  ...
  it('offers user-controlled email categories', () => {
    ...
    expect(page).toContain('Unsubscribe from all')
    expect(page).toContain('unsubscribeFromAllEmail')
    expect(page).toContain('{ interests: false, matches: false, datePlans: false, followUps: false }')
    expect(page).toContain('Unsubscribed from all email notifications.')
  })
})
