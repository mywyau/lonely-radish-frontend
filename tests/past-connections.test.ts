...
describe('past connections', () => {
  ...
  it('allows a fresh apology-led second chance after every ended match', () => {
    ...
    expect(interestService).toContain('Send a brief apology before asking for a second chance')
    ...
    expect(profilePage).toContain('still chooses')
    expect(profilePage).toContain('whether to accept your renewed interest')
  ...
  it('does not let the unmatched person contact past a rejection or renew interest', () => {
    ...
    expect(interestService).toContain('This person ended the connection')
