...
describe('core page contracts', () => {
  ...
  it('mock activity and match pages are routed separately from the preview page', () => {
    ...
    expect(activityMatches).toContain('selected the same activity and are available to receive interest')
    expect(activityMatches).toContain('No one is interested in this activity yet')
