...
describe('received interests', () => {
  it('shows persisted incoming interests without blocked profiles', () => {
    ...
    expect(read('pages/interests/received.vue')).toContain('Expired or withdrawn interests')
    ...
    expect(read('pages/interests/received.vue')).toContain('You chose not to reconnect with ${person.name}.')
    expect(read('pages/interests/received.vue')).toContain("person.reconnectRequest ? 'reconnect' : 'match'")
