    ...
    <section class="mx-auto max-w-3xl">
      ...
      <form class="mt-8 space-y-5" @submit.prevent="save">
        <section class="rounded-lg bg-white p-5 shadow-[0_12px_28px_rgba(180,35,74,0.08)] sm:p-6">
          <div class="flex items-start gap-3"><CalendarClock class="mt-1 size-5 text-[#B4234A]" /><div><h2 class="text-xl font-semibold">Weekly availability</h2><p class="mt-1 text-sm text-[#6E4D58]">Select a day, then set the earliest and latest time that usually works.</p></div></div>
