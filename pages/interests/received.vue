...
async function acceptInterest() {
  ...
  try {
    ...
    successMessage.value = result.queued
      ? `You matched with ${result.name}. The match is queued until you both have space.`
