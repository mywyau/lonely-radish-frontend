...
<template>
  <main class="min-h-screen bg-[#FBF7F1] px-5 py-10 text-[#2A1520] sm:px-8"><section class="mx-auto max-w-3xl">
    ...
    <div v-else-if="!errorMessage" class="mt-7 rounded-lg bg-white p-8 text-center"><UserRound class="mx-auto size-8 text-[#B4234A]" /><h2 class="mt-3 text-xl font-semibold">No interests received yet.</h2><p class="mt-2 text-sm text-[#6E4D58]">When someone chooses you, they will appear here.</p></div>
  </section>
